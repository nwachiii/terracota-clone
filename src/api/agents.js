...
export const fetchCustomers = async () => {
  return await axios.get(`${BaseURL_TWO}/agents/customers/?store_name=${storeName}&sort=lowest_paying_customers_to_highest`, BEARER_TOKEN)
};

export const fetchCustomerInfo = async (id) => {
  return await axios.get(`${BaseURL_TWO}/agents/customers/${id}/?store_name=${storeName}`, BEARER_TOKEN)
};

export const fetchAgentProjectDocument = async (id, purpose) => {
  return await axios.get(`${BaseURL_TWO}/developers/project-documents?project_id=${id}&purpose=${purpose}`, BEARER_TOKEN)
};

export const fetchWithdrawAccounts = async () => {
  return await axios.get(`${BaseURL_TWO}/agents/withdrawals/?accounts=true&store_name=${storeName}`, BEARER_TOKEN)
};
...
export const fetchAllWithdrawal = async () => {
  return await axios.get(`${BaseURL_TWO}/agents/transactions?transaction_type=withdrawal&store_name=${storeName}`, BEARER_TOKEN)
};
export const fetchWithdrawal = async () => {
  return await axios.get(`${BaseURL_TWO}/agents/transactions?store_name=${storeName}&type=withdrawal`, BEARER_TOKEN)
};
...
export const fetchBanksForAgents = async () => {
  return await axios.get(`${BaseURL_TWO}/agents/settings/?store_name=${storeName}&bank=true`, BEARER_TOKEN)
};
...
export const fetchAgentsNotif = async () => {
  return await axios.get(`${BaseURL_TWO}/agents/notify_agent/?store_name=${storeName}`, BEARER_TOKEN)
};
...
export const UpdateSingleAgentNotif = async (id) => {
  return axios.patch(`${BaseURL_TWO}/agents/notify_agent/${parseInt(id)}`, { store_name: storeName }, BEARER_TOKEN);
};

export const deleteAgentsBankDetail = async (id) => {
  return await axios.delete(`${BaseURL_TWO}/agents/settings/${parseInt(id)}?store_name=${storeName}`, BEARER_TOKEN)
};

export const updateAgentSettingsInfo = async (body) => {
  return await axios.patch(`${BaseURL_TWO}/agents/settings/?store_name=${storeName}`, body, BEARER_TOKEN)
};
...
export const AgentSingleListing = async (param) => {
  return await axios.get(`${BaseURL_ONE}/investment/project/${param}?store_name=${storeName}`, BEARER_TOKEN)
};
...
export const fetch_user_payment_breakdown_fractional = async (
  ...
  return await axios.get(`${BaseURL_TWO}/agents/equity_breakdown/${equity_id}/?user=${user_id}&store_name=${storeName}`, BEARER_TOKEN)
};

export const fetch_user_payment_breakdown_fractional_payments = async (
  user_id
) => {
  return await axios.get(`${BaseURL_TWO}/agents/equity_breakdown/?user=${user_id}&store_name=${storeName}&type=FRACTIONAL`, BEARER_TOKEN)
};

export const fetch_user_payment_breakdown_autopay = async (equity_id, user_id) => {
  return await axios.get(`${BaseURL_TWO}/agents/equity_breakdown/${equity_id}/?user=${user_id}&paymentStatus=PAID&store_name=${storeName}`, BEARER_TOKEN)
};

export const fetch_user_payment_breakdown_upcoming_payments = async (equity_id, user_id) => {
  return await axios.get(`${BaseURL_ONE}/transaction/upcoming?user=${user_id}&equity=${equity_id}`, BEARER_TOKEN)
};

export const fetch_user_payment_breakdown_past_payments = async (equity_id, user_id) => {
  return await axios.post(`${BaseURL_ONE}/transaction/equity/${parseInt(equity_id)}/`, {}, BEARER_TOKEN)
};

export const fetchListingTransactions = async (id, filter, sort) => {
  return await axios.get(`${BaseURL_TWO}/agents/listing-customers/${id}/?store_name=${storeName}&${filter == "4" ? "defaulting=true" : filter == "3" ? "outstanding=false" : filter == "2" ? "outstanding=true" : ""}${"&" + sort}`, BEARER_TOKEN)
};
...
export const fetchAgentTerms = async () => {
  return await axios.get(`${BaseURL_TWO}/store/terms?store_name=${storeName}`)
};
...
export const fetchInspectionHistoryForAgents = async (param) => {
  return await axios.get(`${BaseURL_TWO}/agents/inspection-history/${param.id}/?store_name=${storeName}${param.addedParam}      `, BEARER_TOKEN)
};

export const fetchAllListingBundles = async (projectId) => {
  return await axios.get(`${BaseURL_TWO}/investment/project-bundles/?project_id=${parseInt(projectId)}`, BEARER_TOKEN)
};
...
export const fetchAllCommissions = async (name) => {
  return await axios.get(`${BaseURL_TWO}/agents/transactions?type=commission&store_name=${name}`, BEARER_TOKEN)
};
...
export const fetchRecentCommissions = async () => {
  return
  await axios
    .get(`${BaseURL_TWO}/agents/commission-request/${storeName}/`, BEARER_TOKEN)
};
...
export const getAccountGraphDetails = async (val) => {
  return await axios.get(`${BaseURL_TWO}/agents/account/graph?store_name=${storeName}&${val == "3" ? `months=${12}` : val == "2" ? `weeks=${4}` : val == "1" ? `days=${7}` : `days=${7}`}`, BEARER_TOKEN)
};
...
export const addBankDetails = async ({
  ...
  return await axios.post(`${BaseURL_TWO}/agents/withdrawals/`,
    {
      add_account: true,
...
export const requestCommission = async (form, storeName) => {
  return await axios.post(`${BaseURL_TWO}/agents/commission-request/${storeName}/`, form, BEARER_TOKEN)
};

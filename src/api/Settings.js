...
export const fetchBanks = async () => {
  return await axios.get(`${BaseURL_TWO}/store/add-account/?banks=true`, BEARER_TOKEN)
};
...
export const RemoveBankAccount = async (id) => {
  return await axios
    .delete(
      `${BaseURL_TWO}/store/store_settings/${id}?store_name=${storeName}`,
      BEARER_TOKEN
    )
};
...
export const getSettingsData = async (data) => {
  return await axios
    .post(`${BaseURL_TWO}/store/store_settings?store_name=${storeName}`, data, BEARER_TOKEN)
};
...
export const updateSettings = async (data) => {
  return await axios
    .patch(`${BaseURL_TWO}/store/store_settings?store_name=${storeName}`, data, BEARER_TOKEN)
};

export const postDoc = async (data) => {
  return await axios.patch(`${BaseURL_TWO}/store/store_settings?store_name=${storeName}`, data, BEARER_TOKEN)
};

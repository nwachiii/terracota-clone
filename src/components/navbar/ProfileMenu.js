    ...
    <Menu h="fit-content" bg="card_bg">
      <MenuButton alignItems="center" pb="10px">
        <Button
          ...
          rightIcon={<TriangleDownIcon color={useLightItems ? 'white' : 'black'} size={25} />}
        >
        ...
        <MenuItem onClick={() => router.push('/settings')} bg="card_bg">
          <Flex gap={3} align="center" py="5px" onClick={handleSettings}>
            <img
              w="30px"
              h="30px"
              src={appCurrentTheme === LIGHT ? settingIcon.src : settingIconLight.src}
            />
        ...
        >
          <Flex gap={3} align="center" py="5px">
            <img
              w="30px"
              h="30px"
              src={appCurrentTheme === LIGHT ? termsIcon.src : termsIconLight.src}
            />
            <Text color="text" fontWeight="400">
              Terms & Conditions
            </Text>
        ...
        <MenuItem onClick={feedBackModal?.onOpen} bg="card_bg">
          <Flex gap={3} align="center" py="5px">
            <img
              w="30px"
              h="30px"
              src={appCurrentTheme === LIGHT ? feedbackIcon.src : feedbackIconLight.src}
            />
            <Text color="text" fontWeight="400">
              Feedback
            </Text>
        ...
        <MenuItem onClick={suggestModal?.onOpen} bg="card_bg">
          <Flex gap={3} align="center" py="5px">
            <img
              w="30px"
              h="30px"
              src={appCurrentTheme === LIGHT ? suggestIcon.src : suggestIconLight.src}
            />
            <Text color="text" fontWeight="400">
              Suggest an Idea
            </Text>
        ...
        <MenuItem onClick={reportBugModal?.onOpen} bg="card_bg">
          <Flex gap={3} align="center" py="5px">
            <img
              w="30px"
              h="30px"
              src={appCurrentTheme === LIGHT ? reportBugIcon.src : reportBugIconLight.src}
            />
            <Text color="text" fontWeight="400">
              Report a bug
            </Text>

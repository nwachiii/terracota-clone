          ...
          <ModalBody p="0" w="fit-content">
            ...
            <HStack w="full" justify="center" mt='16px'>
              ...
              <Button
                ...
                fontWeight={500}
                onClick={() => (
                  handleSelectedDate(startDate), ShowCalendar.onClose()
                )}
                m="0 auto"
                bg="primary"
                fontSize="12px"
...
export const SelectTime = ({ setTime, time }) => {
  ...
  return (
    <Menu closeOnSelect autoSelect={false} placement="bottom-start">
      <MenuButton
        as={Button}
        _hover={{ opacity: "0.4" }}
        bg="transparent"
      ...
      >
        ...
        <MenuItem bg='transparent' w='full' justifyContent='center' alignItems='center'>
          <Button
            fontWeight={500}

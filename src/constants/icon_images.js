...
export const NOTIFICATION = {
    'wallet_transaction': appCurrentTheme === LIGHT ? wallet_dark : wallet,
    'fractional_ownership': appCurrentTheme === LIGHT ? fractional_dark : fractional,
    'home_purchase': appCurrentTheme === LIGHT ? purchase_dark : purchase,
    'requested_tour': appCurrentTheme === LIGHT ? tour_dark : tour,
    'inspection_request': appCurrentTheme === LIGHT ? tour_dark : tour,
    'equity': appCurrentTheme === LIGHT ? fractional_dark : fractional,
    'request_a_tour': appCurrentTheme === LIGHT ? tour_dark : tour,
    'schedule': appCurrentTheme === LIGHT ? offer_dark : offer,
    'co_ownership': appCurrentTheme === LIGHT ? coOwner_dark : coOwner,
    "what's_next": appCurrentTheme === LIGHT ? story_dark : story,
};

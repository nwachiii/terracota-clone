...
export const RangeMenu = ({
  ...
  return (
    <Flex w={"100%"} mx={"10px"} maxW={maxW} cursor={"pointer"} justify='space-between' align='center'>
      <Menu closeOnSelect={false}>
        <MenuButton as={Box}>
          <HStack my={"8px"}>
            <Text color='text' noOfLines={1} {...themeStyles.textStyles.sl6}>{label}</Text>

...
const ps = (value) =>
  priceString(value, { notation: "compact", compactDisplay: "short" });
...
export const SliderMenu = ({
  ...
  return (
    <Flex w={"100%"} maxW={maxW} cursor={"pointer"} justify='space-between' align='flex-start' direction='column'>
      <Text fontSize='13px' fontWeight='500' fontFamily='Roboto'>{label}</Text>
      <Menu bg='card_bg' closeOnSelect={false} width>
        <MenuButton as={Box}>
          <HStack my={"8px"}>
            <Text fontSize='16px' fontWeight='500' fontFamily='Roboto'>{placeholder}</Text>

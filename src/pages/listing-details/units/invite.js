...
import { Modal, ModalOverlay, ModalContent, ModalBody, Flex, Text, SimpleGrid, Box, ModalCloseButton } from '@chakra-ui/react'
...
const Invite = ({ inviteModal }) => {
  ...
  return (
    <Modal autoFocus={false} onCloseComplete={() => setCurrent('form')} isCentered onClose={inviteModal?.onClose} isOpen={inviteModal?.isOpen}>
      <ModalOverlay />
      ...
      {current === 'form' ? (
              ...
              {({ values, handleChange }) => (
                <Form>
                  <Flex direction='row' justify='space-between' align={'center'} mb='44px'>
                    <Text fontSize={'25px'} fontWeight={600} fontFamily='optimaMedium'>Invite a co-owner</Text>
                    <FaTimes size='20' />
                  </Flex>
        ...
        <ModalContent maxW="430px" px="40px" minH='581px' py='32px'>
          <ModalBody>
            <Box>
              <Flex direction='row' justify='space-between' align={'center'} mb='44px'>
                <Text fontSize={'25px'} fontWeight={600} fontFamily='optimaMedium'>Invitation summary</Text>
                <FaTimes size='20' />
              </Flex>
        ...
        <ModalContent maxW="638px" h='431px' px='41px'>
          ...
          <ModalBody>
            ...
            <Flex direction={'column'} justify={'center'} h='full'>
              <Text {...themeStyles.textStyles.sb3} textAlign='center'>Co-ownership invitation sent successfully</Text>

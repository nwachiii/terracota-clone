      ...
      <Box mt='17px'>
        <Flex align='center' justify={'space-between'} w='full' gap='14px'>
          <Box>
            ...
            <FormInput
              px='3px'
              leftAddon={<Text color='text' mt='12px' fontSize={'20px'}>₦</Text>}
              w={"full"} mt='4px' color='text'
              border={"1px solid !important"}
              borderRadius={"5px"} value={priceFrom}
              onChange={handleMinChange} borderColor='text'
            />
          </Box>
          <Box>
            ...
            <FormInput
              ...
              w={"full"} mt='4px' color='text'
              border={"1px solid !important"}
              borderRadius={"5px"} value={priceTo}
              onChange={handleMaxChange} borderColor='text'
            />
          </Box>
        </Flex>
      </Box>

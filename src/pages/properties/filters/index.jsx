...
const FilterList = ({ onFilterChange }) => {
  ...
  const getQueryString = () => {
    ...
    if (isAppendable(rangeOfPrice[0]))
      queryString.append('price_from', rangeOfPrice[0]);

    if (isAppendable(rangeOfPrice[1]))
      queryString.append('price_to', rangeOfPrice[1]);
      ...
      >
        ...
        >
          <Image
            alt='next_image'
            src={
              appCurrentTheme === LIGHT ? filterIcon.src : filterIcon_light.src
            }
          />
        </Center>
      </Flex>
